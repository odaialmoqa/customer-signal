-- Emergency Database Setup Script for CustomerSignal
-- Run this in your Supabase SQL Editor to fix the "Failed to create tenant" error
...
-- Success message
SELECT 'Database setup complete! You can now create your workspace.' as message;